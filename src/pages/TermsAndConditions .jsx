      ...
      <div className="bg-black border border-slate-800 text-white rounded-lg p-8 shadow-lg">
        ...
        <div className="mb-4">
          <ul className="list-disc list-inside ">
            <li className="mb-2">
              This website is built with the help of multiple resources and it
              is my first big project on MERN Stack
            </li>
            <li className="mb-2">
              Thinking to add some animations in the future
            </li>
            ...
            <li className="mb-2">
              Please review and give suggestions to improve it further
            </li>
          </ul>
        </div>
