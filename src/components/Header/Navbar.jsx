...
import { userLogout, getCurrentUser } from "../../store/Slices/authSlice.js";
  ...
  return (
    <>
      <nav className="w-full bg-[#0E0F0F] flex justify-between items-center p-4 sm:gap-5 gap-2 border-b-2 border-gray-500 sticky top-0 z-50">
        ...
        {authStatus ? (
          <div className="rounded-full sm:flex gap-5 hidden">
            <img
              src={profileImg}
              alt="profileImg"
            ...
            />
            <button
              className="text-white bg-red-800 hover:bg-red-500 duration-500 rounded-lg p-2 "
        ...
        <div
          ...
          } duration-300 text-white flex flex-col border-l h-screen w-[70%] bg-[#0F0F0F] sm:hidden rounded-lg outline-none`}
        >
